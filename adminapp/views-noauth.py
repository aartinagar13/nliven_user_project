...
from .models import Register,ForgetPassword,Gender,Activity,Role
...
def register_view(request):
    if request.method=="POST":
        ...
        if Register.objects.filter(username=username).exists():
          ...
          user = Register(username =username,first_name=first_name,last_name=last_name,email=email,password=password,mobile=mobile,gender_id=gender)
          user.save()
...
def users(request):
    ...
    # show the data of logged in user     
        ...
        users = Register.objects.filter(username=request.user)   
...
def add_user(request):
   ...
   if request.user.is_superuser:
    ...
    if request.method=="POST":
        ...
        user =Register(username=username,first_name=first_name,last_name=last_name,email=email,password=password,gender=gender,mobile=mobile,role_id=role)
